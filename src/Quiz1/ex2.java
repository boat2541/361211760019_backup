...
public class ex2 {
    ...
    public static void main(String[] args) {
        ...
        switch (select) {
            case 1:
                System.out.println("คุณเสียภาษี 10 % ของราคาสินค้า");
                break;
            case 2:
                System.out.println("คุณเสียภาษี 15 % ของราคาสินค้า");
                break;
            case 3:
                System.out.println("คุณเสียภาษี 17 % ของราคาสินค้า");
                break;
            case 4:
                System.out.println("คุณเสียภาษี 40 % ของราคาสินค้า");
                break;
